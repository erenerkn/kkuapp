...
[assembly :Dependency(typeof(Uygulama.Droid.StudentService))]
namespace Uygulama.Droid
{
    public sealed class StudentService : IStudentService
    {
        tr.edu.kku.ogrenciportal webService;
        public StudentService()
        {
            webService = new tr.edu.kku.ogrenciportal();
        }
		...
		public async Task<string> Libary(string userName)
		{
			return await Task.Run(() =>
			{
				var result = webService.GetKutuphaneData(userName);
				return result;
			});
		}
	}
